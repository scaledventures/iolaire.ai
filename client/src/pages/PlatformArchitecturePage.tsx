...
import { ShieldCheck, Radio, Network, Cpu } from "lucide-react";
          ...
          <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                ...
                anchored by a strong, secure policy-driven foundation.
              </p>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
            ...
            >
              <div className="rounded-2xl border border-border/60 bg-card/80 backdrop-blur-sm p-6 md:p-7 flex flex-col">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-6">
                  Policy-led architecture ensures sensitive data is protected and aligned with
